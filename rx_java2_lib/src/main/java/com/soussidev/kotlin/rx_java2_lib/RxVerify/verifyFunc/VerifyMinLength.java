...
public class VerifyMinLength implements Verify<EditText> {
    private static final String DEFAULT_MESSAGE = "Bad length";

    private String lengthMessage;
    private int properLength;

    public VerifyMinLength(int properLength) {
        this(properLength, DEFAULT_MESSAGE);
    }

    public VerifyMinLength(int properLength, String lengthMessage) {
