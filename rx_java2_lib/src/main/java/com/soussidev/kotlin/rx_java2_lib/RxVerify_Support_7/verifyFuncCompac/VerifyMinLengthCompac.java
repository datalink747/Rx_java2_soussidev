...
public class VerifyMinLengthCompac implements VerifyCompac<AppCompatEditText> {
    private static final String DEFAULT_MESSAGE = "Bad length";

    private String lengthMessage;
    private int properLength;

    public VerifyMinLengthCompac(int properLength) {
        this(properLength, DEFAULT_MESSAGE);
    }

    public VerifyMinLengthCompac(int properLength, String lengthMessage) {
