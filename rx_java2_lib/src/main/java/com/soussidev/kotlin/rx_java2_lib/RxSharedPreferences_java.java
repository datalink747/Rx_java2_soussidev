...
public class RxSharedPreferences_java {

    private static final String KEY = "RxSharedPreferences_java";

    private final SharedPreferences sharedPreferences;

    //RxPref init

    public RxSharedPreferences_java(SharedPreferences sharedPreferences) {
        this.sharedPreferences = sharedPreferences;
    }

    public RxSharedPreferences_java(Context context) {
        this(context.getSharedPreferences(KEY, Context.MODE_PRIVATE));
    }

    public static RxSharedPreferences_java with(Context context) {
        return new RxSharedPreferences_java(context);
    }

    public static RxSharedPreferences_java with(SharedPreferences sharedPreferences) {
        return new RxSharedPreferences_java(sharedPreferences);
    }
